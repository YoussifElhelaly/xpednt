...
*/
        ...
        for (var c = ma(a.j()), d = 0; d < c.length; d++) {
            ...
            if (null != b.g[e]) {
                ...
                if (f.m) {
                    ...
                    f = v(b, e),
                    g ? (g = v(a, e)) ? t(g, f) : q(a, e, f.clone()) : q(a, e, f)
            }
        }
    }
    ...
    z.prototype.i = function(a, b) {
        ...
        if (14 == a.i)
            return "string" === typeof b && na.test(b) && (a = Number(b),
            0 < a) ? a : b;
        if (!a.u)
            return b;
        a = a.v;
        if (a === String) {
            if ("number" === typeof b)
                return String(b)
        } else if (a === Number && "string" === typeof b && ("Infinity" === b || "-Infinity" === b || "NaN" === b || na.test(b)))
            return Number(b);
        return b
    }
    ;
    ...
    C.prototype.i = function(a, b) {
        return 8 == a.i ? !!b : z.prototype.i.apply(this, arguments)
    }
    ;
    C.prototype.g = function(a, b) {
        return C.$.g.call(this, a, b)
    }
    ;
    function D(a, b) {
...
*/
    ...
    var ua = {
      ...
      , ya = /[\\\/] *x/
      , za = RegExp("[^0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9A-Za-z#]+$")
      , Aa = /(?:.*?[A-Za-z]){3}.*/
      , Ba = RegExp("^\\+([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]|[\\-\\.\\(\\)]?)*[0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]|[\\-\\.\\(\\)]?)*$")
      , Ca = RegExp("^([A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]+((\\-)*[A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9])*\\.)*[A-Za-z]+((\\-)*[A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9])*\\.?$");
    function M(a) {
    ...
    var Ea = new RegExp("(?:" + Da() + ")$","i")
      ...
      , Ga = /(\$\d)/;
    function Ha(a) {
        return 2 > a.length ? !1 : N(Fa, a)
    }
    function Ia(a) {
        return N(Aa, a) ? O(a, va) : O(a, ua)
    }
    function Ja(a) {
        var b = Ia(a.toString());
        a.i = "";
    ...
    function O(a, b) {
        for (var c = new D, d, f = a.length, e = 0; e < f; ++e)
            d = a.charAt(e),
            d = b[d.toUpperCase()],
            null != d && c.g(d);
        return c.toString()
    ...
    function P(a) {
        return null != a && isNaN(a) && a.toUpperCase()in ta
    }
    function La(a, b, c) {
        ...
        w(g, 5),
        g = w(g, 4),
        f = 2 == c && null != g && 0 < g.length ? f.replace(e, a.replace(Ga, g)) : f.replace(e, a),
    ...
    function V(a, b) {
        return W(a, p(b, 1)) ? W(a, p(b, 5)) ? 4 : W(a, p(b, 4)) ? 3 : W(a, p(b, 6)) ? 5 : W(a, p(b, 8)) ? 6 : W(a, p(b, 7)) ? 7 : W(a, p(b, 21)) ? 8 : W(a, p(b, 25)) ? 9 : W(a, p(b, 28)) ? 10 : W(a, p(b, 2)) ? p(b, 18) || W(a, p(b, 3)) ? 2 : 0 : !p(b, 18) && W(a, p(b, 3)) ? 1 : -1 : -1
    }
    function T(a, b) {
        if (null == b)
            return null;
    ...
    function Y(a, b, c, d) {
        var f = U(c, d)
          , e = 0 == x(f, 9) ? u(p(c, 1), 9) : u(f, 9);
        f = u(f, 10);
        if (2 == d)
            if (Ka(U(c, 0)))
                a = U(c, 1),
                Ka(a) && (e = e.concat(0 == x(a, 9) ? u(p(c, 1), 9) : u(a, 9)),
                e.sort(),
                0 == f.length ? f = u(a, 10) : (f = f.concat(u(a, 10)),
                f.sort()));
            else
                return Y(a, b, c, 1);
        if (-1 == e[0])
    ...
    function Pa(a, b, c, d, f, e) {
        ...
        if (0 == h.length)
            ...
            if (0 == g.search(h)) {
                ...
                var l = g.substring(h).match(wa);
                l && null != l[1] && 0 < l[1].length && "0" == O(l[1], ua) ? g = !1 : (b.i = "",
                b.g(g.substring(h)),
                g = !0)
            } else
                g = !1;
        ...
        h = "" + g,
        l = b.toString(),
        0 == l.lastIndexOf(h, 0) && (h = new D(l.substring(h.length)),
        l = p(c, 1),
        l = new RegExp(w(l, 2)),
        Qa(h, c, null),
        h = h.toString(),
        !N(l, b.toString()) && N(l, h) || 3 == Y(a, b.toString(), c, -1))))
            return d.g(h),
            f && q(e, 6, 10),
            q(e, 1, g),
            g;
    ...
    function Ra(a, b, c, d) {
        ...
        var h = e;
        null == h ? g = !0 : 0 === h.length ? g = !1 : (g = Ba.exec(h),
        h = Ca.exec(h),
        g = null !== g || null !== h);
        if (!g)
            throw Error("The string supplied did not seem to be a phone number");
        ...
        try {
            ...
            if ("Invalid country calling code" == F.message && L.test(l)) {
                if (l = l.replace(L, ""),
                h = Pa(a, l, g, b, d, e),
                0 == h)
                    throw F;
    ...
    k("intlTelInputUtils.formatNumber", (a,b,c)=>{
        try {
            const f = K.g()
              , e = Z(f, a, b);
            var d = Oa(f, e);
            return 0 == d || 4 == d ? La(f, e, "undefined" === typeof c ? 0 : c) : a
        } catch (f) {
            return a
        }
    }
    ...
    k("intlTelInputUtils.isValidNumber", (a,b)=>{
        try {
            ...
            a = X;
            var d = Na(a, c);
            var f = w(c, 1), e = R(a, f, d), g;
            if (!(g = null == e)) {
                var h;
                if (h = "001" != d) {
                    var l = T(a, d);
                    if (null == l)
                        throw Error("Invalid region code: " + d);
                    var A = w(l, 10);
                    h = f != A
                }
                g = h
