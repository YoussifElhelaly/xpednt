...
export function Light3d5({x}) {

  const gltf = useLoader(GLTFLoader, '/loupes/slimScope3.5.glb');
 ...
 useEffect(() => {
  ...
  return (
    <>
      <primitive object={gltf.scene} position={[0.030, 0.010, handleYAxisSlim(frame.id)]} rotation={[ 0,Math.PI / 90, 0]}/>
    </>
  
  )
}

useGLTF.preload('/loupes/slimScope3.5.glb')
